<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Hesabınızın profil bilgileri ve eposta bilgisini güncelle.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="telefon" type="tel" class="mt-1 block w-full" wire:model.defer="state.telefon" autocomplete="telefon" />
