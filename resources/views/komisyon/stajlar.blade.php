                ...
                <form class="row d-flex justify-content-between"" method="GET" action="" enctype="multipart/form-data">
                    ...
                    @if (request()->get('search'))
                        <div class="col d-flex justify-content-end">
                            <a href="{{ route('komisyon.stajlarget') }}" class="btn btn-secondary">
                                Sıfırla
                            </a>
                        </div>
                    @endif
                ...
                <tbody>
                    @foreach ($stajlar as $staj)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('komisyon.stajget',$staj->id)}}" class="btn btn-primary"><i class="bi bi-pencil-square"></i> Staj Detayları</a>
                                <form action="{{ route('komisyon.stajdelete', $staj->id) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
