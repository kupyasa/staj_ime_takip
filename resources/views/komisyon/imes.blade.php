                ...
                <form class="row d-flex justify-content-between"" method="GET" action="" enctype="multipart/form-data">
                    ...
                    @if (request()->get('search'))
                        <div class="col d-flex justify-content-end">
                            <a href="{{ route('komisyon.imesget') }}" class="btn btn-secondary">
                                Sıfırla
                            </a>
                        </div>
                    @endif
                ...
                <tbody>
                    @foreach ($imes as $ime)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('komisyon.imeget', $ime->id) }}" class="btn btn-primary"><i
                                        class="bi bi-pencil-square"></i> İME Detayları</a>
                                <form action="{{ route('komisyon.imedelete', $ime->id) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
