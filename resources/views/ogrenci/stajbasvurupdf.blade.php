...
<body>
    ...
    <h6 class="title">(Staj Başvuru ve Kabul formu)</h6>
    ...
    <p class="text center_text">{{ $fakulte }} Fakültesi {{ $bolum }} Bölümü {{ $ogrenci_no }} numaralı
        öğrencisiyim. Kurumunuzda staj yapmamın uygun görülmesi halinde bu formun alttaki kısmını doldurularak
        fakültemiz ilgili bölüm başkanlığına gönderilmesini saygılarımla arz ederim.
        İşyeri uygulaması süresi içerisinde alınan rapor, istirahat vb. belgelerin aslını alınan gün içerisinde bölüm
        başkanlığına bildireceğimi<span class="bold"> beyan ve taahhüt ederim.</span></p>
    ...
    <table class="center">
        ...
        <tr>
            ...
            <td class="text" colspan="1">{{ $tc_no }}</td>
            <th class="text">Uyruğu</th>
            <td class="text" colspan="1">{{ $uyruk }}</td>
        </tr>
        <tr>
    ...
    <table class="center">
        <tr>
            <th class="text center_text" colspan="3">Staj Bilgileri* **</th>
        </tr>
        <tr>
            <th class="text center_text" colspan="3">{{ $staj_tipi }}</th>
        </tr>
        <tr>
            <th class="text" colspan="1">Başlama Tarihi: {{ date('d/m/Y', strtotime($staj_baslangic)) }}</th>
    ...
    <table class="center">
        <tr>
            <th class="text center_text" colspan="4">Staj Yapılacak Kurum Bilgileri</th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="text" colspan="1">Staj Sorumlusunun Unvanı</th>
            <td class="text" colspan="3">{{ $sorumlu_unvan }}</td>
        </tr>
        <tr>
            <th class="text" colspan="2">Kurum olarak 3308 sayılı kanundaki devlet
                katkısından yararlanmak istiyor musunuz?***</th>
            <th class="text" colspan="2">{{ $devlet_katki_check ? 'Evet' : 'Hayır' }}</th>
        </tr>
    </table>
    <p class="text center_text" style="font-size: 0.6em">Yukarıda adı geçen öğrencinin ilgili tarihlerde staj
        uygulamasını kurumumuzda yapması uygun görülmüştür.</p>
    <h6 class="right" style="margin-right: 14.5em">Ad Soyad:</h6>
    <h6 class="right" style="margin-right: 14.5em">Unvan:</h6>
    <h6 class="right" style="margin-right: 14.5em">İmza:</h6>
    <br>
    <p class="text center_text bold" style="font-size: 0.5em">3308 sayılı Meslekî Eğitim Kanunu ve 5510 sayılı Sosyal
        Sigortalar ve Genel Sağlık Sigortası Kanununun 5 inci maddesinin (b) bendi gereğince zorunlu staja tabi tüm
        öğrencilere "İş Kazası ve Meslek Hastalığı Sigortası" yapılması ve sigorta primlerinin Üniversite tarafından
        ödenmesi gerekmektedir. Staj süresi boyunca üniversitemiz tarafından öğrencimizin SGK’ya kaydı yaptırılacaktır.
    </p>
    <p class="text center_text bold" style="font-size: 0.5em">Staja SGK sicil numarası alındıktan sonra başlayacaktır.
        Farklı firmalarda yapılacak stajlar için ayrı form doldurulacaktır. Öğrenci bu evraktan 2 nüsha düzenleyip
        firmaca onaylandıktan sonra bir tanesini belirlenen staj döneminden en az 1 ay önce ilgili bölüm başkanlığına
        teslim etmek zorundadır.</p>
    <p class="text center_text bold" style="font-size: 0.5em"> Yanıtınız Evet ise Ek-1 formunu doldurunuz.</p>

    <table class="center">
        <tr>
            <th class="text center_text" colspan="1">T.C. Kocaeli Üniversitesi {{ $fakulte }} Fakültesi
                Bölüm İş Yeri ve Staj Komisyonu Onayı</th>
            <th class="text center_text" colspan="1" style="font-size: 0.5em">Yukarıda adı geçen öğrencinin ilgili
                tarihlerde
                staj uygulamasını ilgili kurumda yapması <p style="display: inline-block;text-align:left">Uygundur
