<x-app-layout title='Staj Başvurusu Yap'>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">{{ __('Staj Başvurusu Yap') }} </h2>
    </x-slot>

    <div class="card">
        <div class="card-body">
            <form action="{{route('ogrenci.stajbasvurusuyappost')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="uyruk" name="uyruk" value="{{ old('uyruk') }}"
                        required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="staj_tipi" id="staj_tipi" required>
                        <option value="Staj-I" selected>
                            Staj-I</option>
                        <option value="Staj-II">
                            Staj-II</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label for="staj_baslangic" class="form-label">Staj Başlangıç Tarihi</label>
                    <input type="date" class="form-control" value="{{ old('staj_baslangic') }}"
                        id="staj_baslangic" name="staj_baslangic" required>
                </div>
                <div class="mb-3">
                ...
                <h4 class="text-center">Staj Yapılacak Kurum Bilgileri</h4>
                ...
                <div class="mb-3">
                    <label for="sorumlu_unvan" class="form-label">Staj Sorumlusunun Unvanı</label>
                ...
                <div class="mb-3">
                    <input type="checkbox" @if (old('devlet_katki_check')) checked @endif id="devlet_katki_check"
                        name="devlet_katki_check">
                    <label for="devlet_katki_check" class="form-label">Kurum olarak 3308 sayılı kanundaki devlet
                        katkısından yararlanmak istiyor musunuz?
                    </label>
                </div>

                <div class="text-end">
                    <button type="submit" class="btn btn-primary">Staj Başvurusu Yap</button>
                </div>
            </form>
        </div>
    </div>
