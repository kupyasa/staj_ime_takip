                ...
                <form class="row d-flex justify-content-between"" method="GET" action="" enctype="multipart/form-data">
                    ...
                    @if (request()->get('search'))
                        <div class="col d-flex justify-content-end">
                            <a href="{{ route('ogretmen.stajlarget') }}" class="btn btn-secondary">
                                Sıfırla
                            </a>
                        </div>
                    @endif
                ...
                <tbody>
                    @foreach ($stajlar as $staj)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('ogretmen.stajget',$staj->id)}}" class="btn btn-primary"><i class="bi bi-pencil-square"></i> Staj Detayları</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
